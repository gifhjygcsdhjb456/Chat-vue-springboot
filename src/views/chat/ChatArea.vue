  ...
  <div class="chat-area__com">
    ...
    <div class="message-edit-container">
      <div class="tool">
        ...
        <span class="tool-item">
          <i class="item el-icon-folder" @click.stop="showUpFileCom = !showUpFileCom"></i>
        ...
        <span
          ...
          :class="
            showHistoryMsg
              ? 'history-btn normal-font el-icon-caret-bottom'
              : 'history-btn normal-font el-icon-caret-top'
          "
