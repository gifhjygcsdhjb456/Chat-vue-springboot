<template>
  ...
  >
    <div class="co-artboard-main">
      ...
      <el-row> <el-button type="danger" icon="el-icon-star-off" circle></el-button> </el-row>
      <div class="drawingarea">
        <div class="select-list">
          <div v-for="v in handleList" :key="v.type" class="select-item">
            ...
            <button
              :disabled="
                v.type === 'cancel' ? !isToPeer || allowCancel : v.type === 'go' ? !isToPeer || allowGo : !isToPeer
              "
              @click="handleClick(v)"
  ...
  methods: {
    ...
    initPeer(data) {
      ...
      this.peer.onicecandidate = (event) => {
        ...
        // console.log("选取最佳链接方式时的候选事件参数：", event.candidate)
        if (event.candidate) {
