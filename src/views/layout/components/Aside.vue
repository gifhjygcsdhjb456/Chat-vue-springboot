<template>
  <div class="layout-cmp__aside">
    ...
    <div class="nav-list">
      <router-link to="/" tag="span" title="去聊天">
        <span class="nav-item iconfont icon-pinglun1"></span>
      </router-link>
    </div>
    <div class="nav-list">
